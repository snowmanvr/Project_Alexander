...
public class Capitals {
	...
	private void initialize() {
		...
		startButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) { // ACTION OF "START"
				...
				int whichQuestionIsNow = 1;
				String answer1 = null, answer2 = null, answer3 = null, answer4 = null;
				String question = "Коя е столицата на ";
				int rightAnswer = 0;
				startTheGame(firstPlayerPoints, secondPlayerPoinst, whichTurnIsNow,whichQuestionIsNow, firstPlayerName,secondPlayerName,answer1,answer2,answer3,answer4,question,rightAnswer);
	...
	private void startTheGame(int firstPlayerPoints, int secondPlayerPoinst, int whichTurnIsNow,int whichQuestionIsNow,String firstPlayerName,String secondPlayerName,String answer1,String answer2,String answer3,String answer4,String question,
	int rightAnswer) {

		switch (whichQuestionIsNow) {
		case (1):
			...
			break;
		case (2):
			question = question + "Мадагаскар?";
			answer1 = "Абуджа";
			answer2 = "Киншаса";
			answer3 = "Антананариво";
			answer4 = "Уагадуги";
			rightAnswer = 3;
			break;
		case (3):
			question = question + "Камерун?";
			answer1 = "Хараре";
			answer2 = "Яунде";
			answer3 = "Могадишу";
			answer4 = "Претория";
		...
		buttonsAndAnswer(answer1, answer2, answer3, answer4, rightAnswer, firstPlayerPoints, secondPlayerPoinst,
				whichTurnIsNow, whichQuestionIsNow, lblHereIsPlayer1Name, lblHereIsPlayer2Name, lblTurn, lblHereIsTheCurrentQuestion
				, firstPlayerName,  secondPlayerName,  question);
	...
	private void buttonsAndAnswer(String answer1, String answer2, String answer3, String answer4, int rightAnswer,
			int firstPlayerPoints, int secondPlayerPoinst, int whichTurnIsNow,int whichQuestionIsNow, JLabel lblHereIsPlayer1Name,
			JLabel lblHereIsPlayer2Name, JLabel lblTurn, JLabel lblHereIsTheCurrentQuestion, String firstPlayerName, String secondPlayerName, String question) {
			...
			public void actionPerformed(ActionEvent e) {
				if (rightAnswer == 1) {
					if (whichTurnIsNow % 2 == 0) {
						...
						startTheGame(firstPlayerPoints, secondPlayerPoinst, whichTurnIsNow,whichQuestionIsNow, firstPlayerName,secondPlayerName,answer1,answer2,answer3,answer4,question,rightAnswer);
						hideButtons(lblHereIsPlayer1Name, lblHereIsPlayer2Name, lblTurn, lblHereIsTheCurrentQuestion,
	...
	@SuppressWarnings("deprecation")
	public static void hideButtons(JLabel lblHereIsPlayer1Name, JLabel lblHereIsPlayer2Name, JLabel lblTurn,
			JLabel lblHereIsTheCurrentQuestion, JButton btnAnswer1, JButton btnAnswer2, JButton btnAnswer3,
			JButton btnAnswer4) {
